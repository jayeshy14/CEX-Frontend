...
const DepositPage = () => {
  ...
  const [isCryptoDeposit, setIsCryptoDeposit] = useState(true);
  ...
  const handleCryptoDeposit = async () => {
    await depositCrypto(selectedCrypto, selectedChain, amount, ethereumSigner);
  };
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between gap-6">
                ...
                <div className="flex-1 relative group">
                  ...
                  <div className={`relative border border-gray-700 rounded-xl p-3 shadow-lg transition-all duration-300 ${selectedCrypto ? "bg-gray-900" : "bg-gray-800 opacity-50 cursor-not-allowed"}`}>
                    <select
